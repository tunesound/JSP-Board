...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD">
	<tr>
		...
		<td width=450 align=right>
 			<a href="<%=request.getContextPath()%>/UserServlet?cmd=USER_LIST"><img name="back" src="<%=request.getContextPath()%>/_images/buttons/back.gif" width="41" height="13" alt="사용자 리스트 보기" border="0" hspace=15 vspace=5 align=middle></a>
		</td>
...
<table>
	...
	<tr>
		...
		<td><select name="status" > 
			<option value='1' <%if (userbean.getStatus()==1) out.print("selected"); %>>사용가능</option>
			<option value='2' <%if (userbean.getStatus()==2) out.print("selected"); %>>사용중지</option>				
			</select>			
	    </td>
	</tr>		
	<tr>
